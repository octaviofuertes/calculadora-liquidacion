  ...
  function categoryAuditRows(conv = {}) {
    return (conv.categorias || []).map((category) => {
      ...
      return {
        ...
        grupo_nombre: category.grupo_nombre || category.group || category.grupo || category.convenio_rama || conv.convenio?.rama || "",
        rama: category.rama || category.grupo_nombre || category.group || category.grupo || category.convenio_rama || conv.convenio?.rama || ""
      };
    });
  }
