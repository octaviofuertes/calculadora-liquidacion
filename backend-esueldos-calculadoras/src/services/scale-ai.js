...
function buildScalePrompt({ convention, period, periodLabel }) {
  ...
  return [
    ...
    "Si el PDF contiene importes para varios meses o periodos bajo revisión, crea una escala separada por cada mes/periodo detectado. Ejemplo: si una escala de Farmacia trae basico Abril 2026 y columnas no remunerativas Abril/Mayo/Junio 2026, devolve tres escalas: 2026-04, 2026-05 y 2026-06. Repite el basico en cada mes y cambia el no remunerativo segun la columna de ese mes.",
    "VALORES ACTUALES: Extraer únicamente las escalas y valores correspondientes a los periodos más recientes/actuales bajo revisión. Ignorar por completo las escalas y tablas del historial histórico de años o paritarias anteriores que ya no estén vigentes.",
