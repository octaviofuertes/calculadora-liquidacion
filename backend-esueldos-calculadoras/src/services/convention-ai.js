...
function buildConventionCorePrompt({ draftName, notes }) {
  return [
    ...
    "Si una categoria tiene variantes liquidatorias por modalidad, jornada, alcance, rama o condicion con valores distintos, separarlas en categorias distintas. No compactar modalidades incompatibles en una sola categoria.",
    "conceptos: conceptos liquidables remunerativos, no remunerativos, retenciones y contribuciones detectadas, con campos minimos completos. Condiciones y formulas en frases cortas.",
