...
// GENERATED CALCULATOR FOR CONVENIO: CONVENIO_COLECTIVO_DE_TRABAJO_DE_CENTROS_DE_CONTACTO
...
module.exports = {
  getMetadata: () => {
    return [
      ...
      { id: "concept_PRESENTISMO_PUNTUALIDAD", label: "Puntualidad", type: "checkbox", defaultValue: true }
    ].filter(Boolean);
  },
  ...
  calculate: (ctx) => {
    ...
    if (inputs["concept_PRESENTISMO_PUNTUALIDAD"] !== false && String(inputs["concept_PRESENTISMO_PUNTUALIDAD"]) !== "false" && inputs["concept_PRESENTISMO_PUNTUALIDAD"] !== "0") {
      ...
      if (val !== 0) addRow(rows.remRows, "Puntualidad", val, "0%");
    }
